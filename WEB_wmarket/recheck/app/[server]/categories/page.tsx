...
// Same shared 15s ISR cache as /items and /market — grouping/ranking is
// derived client-side from data that's already fetched and cached, so this
// page adds zero extra backend reads.
export const revalidate = 15;

export default async function CategoriesPage({ params }: { params: Promise<{ server: string }> }) {
  ...
  return <CategoriesClient server={server} items={items} />;
}

...
## v45 Review
- Restrict icon-only Next fallback to navigation-like candidates.
- Prevent generic right-edge shop items from being clicked as Next.
- Keep priced Arrow products excluded from navigation.
- Add regression coverage for generic right-edge false positives.
